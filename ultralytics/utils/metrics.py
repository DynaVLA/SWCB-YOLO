...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, MPDIoU=False, SIoU=False, EIoU=False,
             ShapeIoU=False,EnMPDIoU=False,EnSIoU=False, EnEIOU=False, CAShapeIoU=False,
             alpha=1, scale=0.0, eps=1e-7):
    """
    ...
    # IoU
    iou = inter / union
    if CIoU or DIoU or GIoU or MPDIoU or SIoU or EIoU or ShapeIoU or EnMPDIoU or EnSIoU or EnEIOU or CAShapeIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing box) width
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if CIoU or DIoU or MPDIoU or SIoU or EIoU or ShapeIoU or EnMPDIoU or EnSIoU or EnEIOU or CAShapeIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            c2 = cw.pow(2) + ch.pow(2) + eps  # convex diagonal squared
            rho2 = (
                           (b2_x1 + b2_x2 - b1_x1 - b1_x2).pow(2) + (b2_y1 + b2_y2 - b1_y1 - b1_y2).pow(2)
                   ) / 4  # center dist**2
            if CIoU or CAShapeIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                # Base alignment term of CA-Shape-IoU is the CIoU criterion (paper, Eq. (10)):
                # 1 - IoU + rho^2 / c^2 + alpha * v. The morphological compensation terms
                # (curvature / Voronoi / elongation) are added in BboxLoss, not here.
